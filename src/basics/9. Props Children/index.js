...
const App = () => {
  return (
    ...
    >
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam iste molestias numquam,
        ratione adipisci atque quia et. Voluptas, soluta? Quibusdam accusantium quis saepe. Aliquam
        facilis quia obcaecati odio quo quos.
      </p>
    </User>
  );
};
